...
import {closeSide} from "../js/main.js"
import "../css/sideBar.css"

function SideBar(){
    return(
        <div className="sidebar" id="sideBar">
        <div id="sec1" className="sideitem">
          <p className="side_text">Hello !</p>
          <button className="btn" onClick={closeSide}>
        ...
        <div id="sec2" className="sideitem">
          <div className="midsec">
            <div className="minisecs">
              <a>
              ...
              <p  className="side_text">Profile</p>
            </div>
            <div className="minisecs">
              <a>
              ...
              <p  className="side_text">placeholder</p>
            </div>
            <div className="minisecs">
              <a>
                <svg viewBox="0 0 24 24" className="iconSVG">
